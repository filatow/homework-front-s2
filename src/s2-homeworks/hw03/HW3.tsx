...
* 7 - в файле GreetingContainer.tsx дописать логику функций pureAddUser, pureOnBlur,
* pureOnEnter и проверить их тестами [done]
* 8 - в файле GreetingContainer.tsx вычислить количество добавленных
* и имя последнего (totalUsers, lastUserName) [done]
